---
title: "HashCode Google"
summary: "Collection of Google Hash Code challenge solutions."
sourceUrl: https://github.com/evilz/HashCode-Google
topics:
  - challenge
  - google
  - hash-code
...
<img src="https://www.google.fr/images/branding/googlelogo/2x/googlelogo_color_120x44dp.png" alt="Google Logo" height="80">
<img height="80" src="https://hashcode.withgoogle.com/resources/logo/hashcode_hero.png" alt="Hash Code logo">

# Google Hash Code Challenge Archive
...
This repository now includes a .NET 9.0 CLI application to explore and run Hash Code challenges!
...
### Features
- Browse all challenges by year
- View full problem descriptions
- Read solution explanations
- Run solutions on challenge input files
- Beautiful interactive terminal UI

See [CLI README](src/HashCodeCli/README.md) for more details.
...
- Problem statement (PDF): [hashcode2014_final_task.pdf](2014/hashcode2014_final_task.pdf)
- Reference solution (F# script): [2014-final.fsx](2014/2014-final.fsx)
- Sample input: [paris_54000.txt](2014/paris_54000.txt)
